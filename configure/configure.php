<?php
	...
	function my_custom_sidebar() {
	    register_sidebar(
	        array (
	            ...
	            'id' => 'custom-side-bar',
	            'description' => __( 'Custom blog sidebar'),
	...
	function footer_location_address() {
	    register_sidebar(
	        array (
	            'name' => __( 'Footer Location Text'),
	            'id' => 'footer-location-txt',
	            'before_widget' => '',
	            'after_widget' => "",
	            'before_title' => '',
	            'after_title' => '',
	...
	add_action( 'widgets_init', 'footer_location_address' );

	function footer_disclaimer_txt() {
	    register_sidebar(
	        array (
	            'name' => __( 'Footer Dislaimer Text'),
	            'id' => 'footer-disclaimer-txt',
	            'before_widget' => '',
	            'after_widget' => "",
	            'before_title' => '',
	            'after_title' => '',
	...
	add_action( 'widgets_init', 'footer_disclaimer_txt' );
